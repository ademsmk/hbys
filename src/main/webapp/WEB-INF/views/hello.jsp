...
<div  align = left style="padding-top: 20px;">
	...
	<table>
	     ...
	     <tr><td>Dosya No </td><td> : <div class="form-group"><form:input class="form-control" id="add-name" type="text" placeholder="Name" path="name" /></div></td></tr>
	     <tr><td>Adi Soyadi  </td><td> : <div class="form-group"><form:input class="form-control" id="add-surname" type="text"  placeholder=" Surname" path="surname"></form:input></div></td></tr>
	     <tr><td>Dogum Yeri  </td><td> : <div class="form-group"><form:input class="form-control" id="add-email" type="text" placeholder=" Email" path="email"></form:input></div></td></tr>
	     <tr><td>Dogum Tarihi  </td><td> : <div class="form-group"><form:input class="form-control" id="add-number" type="text" placeholder="Phone Number" path="phoneNumber"></form:input></div></td></tr>
	                 <tr> <td>  <input class="btn btn-default" type="submit" value="Add"  > </td></tr>
